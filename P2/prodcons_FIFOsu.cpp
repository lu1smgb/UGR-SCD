/*
   ...
   Problema del productor-consumidor con buffer FIFO
...
constexpr int
   num_items  = 20, // Numero de valores a producir
...
/////////////////////////////////////////////////////////////////////////////////////////////
// declaración del monitor SU (buffer FIFO)
...
int main()
{
   ...
   if (num_items % num_prod != 0 or num_cons % num_cons != 0) {
    ...
    cout << "-------------------------------------------------------------------------------" << endl
         << "Problema de los productores-consumidores (" << num_prod << " prod/" << num_cons << " cons, Monitor SU, buffer FIFO). " << endl
         << "-------------------------------------------------------------------------------" << endl
         << flush;
